...
const ClientDashboard = () => {
  ...
  const selectExpert = async (serviceId, expert) => {
    try {
      ...
      toast.success("✅ Expert Selected successfully!");
        ...
        <div className="w-full space-y-4">
          <div className="flex items-center bg-white/20 p-4 rounded-lg w-full">
            ...
            <p className="text-lg">
              Total Services:{" "}
              <strong>
                {loading ? <Skeleton width={30} /> : services.length}
              </strong>
            </p>
          </div>
          <div className="flex items-center bg-white/20 p-4 rounded-lg w-full">
            ...
            <p className="text-lg">
              Interested Experts:{" "}
              <strong>
                {loading ? <Skeleton width={30} /> : totalInterestedExperts}
              </strong>
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:ml-[260px] px-6 sm:px-8 py-10">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">
            No service requests found. Please create one.
          </p>
        ) : (
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16">
              ...
              >
                ...
                <div className="mt-3 space-y-2 text-gray-700">
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    <strong>Interested Experts:</strong>{" "}
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    {expandedService === service._id ? (
                      ...
                      <>
                        <FaChevronDown className="text-white" /> View Interested
                        Experts
                      </>
                    )}
                  </button>
                  ...
                  >
                    {service.status === "Completed" ? (
                      <>
                        <FaRedoAlt className="group-hover:text-white text-reopen" />{" "}
                        Reopen Service
                      </>
                    ) : (
                      <>
                        <FaTimes className="group-hover:text-white text-close" />{" "}
                        Close Service
                      </>
                    )}
                  </button>
